...
public class SmallHeadPanel extends JPanel {
    ...
    public SmallHeadPanel() {
        ...
        minimizeButton.setForeground(Color.decode("#333333"));
        ...
        closeButton.setForeground(Color.decode("#333333"));
