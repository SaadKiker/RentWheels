 ...
 * @author saadk
 */
public class VisitorCarFrameSP extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        clientCarFrame1 = new com.saad.VisitorComponents.VisitorCarFrame();
        ...
        sp.setViewportView(clientCarFrame1);
        ...
        jcb1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "   -", "Price - Lower to Higher", "Price - Higher to Lower", "Available", "Unavailable" }));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(sp, javax.swing.GroupLayout.DEFAULT_SIZE, 446, Short.MAX_VALUE))
        );
    ...
    private void filterKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_filterKeyTyped
                ...
                clientCarFrame1.CarCardGrid.removeAll();
                ...
                for (Car car : filteredCarList) {
                    ...
                    clientCarFrame1.CarCardGrid.add(carCard);
                }

                clientCarFrame1.CarCardGrid.revalidate();
                clientCarFrame1.CarCardGrid.repaint();
   ...
   String selectedOption = (String) jcb1.getSelectedItem();
        ...
        clientCarFrame1.CarCardGrid.setLayout(new GridLayout(0, 3, 15, 15)); // Adjust the spacing as needed
        ...
        } else if (selectedOption.equals("Available")) {
        ...
        for (Car car : sortedCarList) {
            ...
            clientCarFrame1.CarCardGrid.add(panelWrapper);
        }
...
g2.fillRoundRect(0, 0, getWidth(), getHeight(), 0, 0);  
    ...
    private com.saad.VisitorComponents.VisitorCarFrame clientCarFrame1;
